    ...
    def write_json_report(self, data: Dict, filename: str) -> str:
        ...
        try:
            ...
            with open(output_path, 'w', encoding='utf-8') as f:
                # Create encoder factory that includes primary_issue_component
                def encoder_factory(*args, **kwargs):
                    kwargs['primary_issue_component'] = self.config.primary_issue_component
                    return ComponentAwareEncoder(*args, **kwargs)
                
                json.dump(json_data, f, cls=encoder_factory, indent=2)
