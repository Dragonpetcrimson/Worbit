...
try:
    from utils.path_utils import setup_output_directories, get_output_path, OutputType, get_standardized_filename, normalize_test_id
except ImportError:
...
class DirectoryStructureTest(unittest.TestCase):
    ...
    def test_path_generation(self):
        ...
        self.assertNotIn("supporting_images/supporting_images", image_path,
